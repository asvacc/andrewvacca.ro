...
<template>
    <div class="block sm:hidden">
        <svg @click="toggle" class="block transition-colors cursor-pointer sm:hidden size-8 hover:text-red-400"
        ...
        <Teleport to="body">
            <Transition>
                <div v-if="menuToggle"
                    class="fixed inset-0 top-0 z-20 flex flex-col items-center justify-center w-full h-full sm:hidden sm:fixed bg-red-400">
