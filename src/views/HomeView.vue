      ...
      <Transition appear>
        <div>
          ...
          <p
            ...
            <span class="text-transparent bg-gradient-to-r from-[#4568DC] to-[#B06AB3] bg-clip-text">Software
              Engineer</span> with an eye for design.
          </p>
        </div>
      </Transition>
      <div class="md:min-h-[31.25rem] flex flex-col md:items-end items-center justify-center">
        <img class="w-auto h-full mt-8 sm:mt-0" height="710" width="592" title="Me" alt="Me" src="/me.svg" />
      </div>
    </div>

    <div class="flex justify-center md:justify-start">
      <RouterLink class="mt-12 md:mt-16 lg:mt-20 btn" to="/contact">Contact</RouterLink>
    </div>
  </div>
</template>
